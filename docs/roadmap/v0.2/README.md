...
| N2  | [Node sidecar runner](./N2-node-sidecar-runner.md)             | Tauri Rust 가 Node sidecar 를 spawn, harness 실행 webview 밖으로       | —             | ▶ 다음                              |
...
> N0 + N1 ✅ 완료. 다음은 N2 (Node sidecar) — v0.1 의 가장 큰 구조적 한계 해결. N4 / N6 은 N0 위에서 N2 와
> 병행 가능. N5 는 N2 의 cancel IPC 가 먼저.
